...
namespace ImGui
{
    ...
    IMGUI_API bool          IsMouseDragging(ImGuiMouseButton button = 0, float lock_threshold = -1.0f);         // is mouse dragging? (if lock_threshold < -1.0f, uses io.MouseDraggingThreshold)
